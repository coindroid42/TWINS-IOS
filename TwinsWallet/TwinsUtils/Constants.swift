...
struct K {
    ...
    struct color {
        ...
        static let purple_r85g71b108 = UIColor.rgb(27, green: 30, blue: 38)
        static let white = UIColor.rgb(255, green: 255, blue: 255)
        static let orange = UIColor.rgb(233, green: 63, blue: 51)
        static let green = UIColor.rgb(92, green: 181, blue: 75)
